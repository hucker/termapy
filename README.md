...
```sh
uv tool install --python 3.14 git+https://github.com/hucker/termapy@v0.38.0
termapy --demo
```
...
```sh
uvx --from git+https://github.com/hucker/termapy@v0.38.0 termapy --demo
```
...
<details>
<summary><strong>Test Coverage</strong> — 888 tests, 60% overall</summary>

888 tests across 19 test files. Run with `uv run pytest`.
