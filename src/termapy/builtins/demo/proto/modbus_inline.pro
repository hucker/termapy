...
# Same tests as modbus_test.pro but decoded with send_fmt/recv_fmt
...
recv_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 CRC:crc16-modbus_le"
...
recv_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 R1:U6-7 CRC:crc16-modbus_le"
...
recv_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 R1:U6-7 R2:U8-9 R3:U10-11 R4:U12-13 CRC:crc16-modbus_le"
...
recv_fmt = "Title:Modbus_Echo Slave:H1 Func:H2 Reg:U3-4 Value:U5-6 CRC:crc16-modbus_le"
...
recv_fmt = "Title:Modbus_Exception Slave:H1 ErrFunc:H2 Code:U3 CRC:crc16-modbus_le"
