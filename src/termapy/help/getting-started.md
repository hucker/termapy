...
- **Cfg** opens the config picker (Load / Edit / Explorer / New / Rename / Delete / Cancel; the Explorer button reads Finder on macOS and Files on Linux), listed newest first with size, age, port, baud, and title.
