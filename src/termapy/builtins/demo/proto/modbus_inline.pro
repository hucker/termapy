...
send_fmt = "Title:Modbus_TX Slave:H1 Func:H2 Addr:U3-4 Count:U5-6 CRC:crc16-modbus"
expect = "01 03 02 00 07 F9 86"
expect_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 CRC:crc16-modbus"
...
expect_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 R1:U6-7 CRC:crc16-modbus"
...
expect_fmt = "Title:Modbus_Response Slave:H1 Func:H2 Bytes:U3 R0:U4-5 R1:U6-7 R2:U8-9 R3:U10-11 R4:U12-13 CRC:crc16-modbus"

[[test]]
name = "Write register 5 = 1234"
send = "01 06 00 05 04 D2 1B 56"
send_fmt = "Title:Modbus_TX Slave:H1 Func:H2 Reg:U3-4 Value:U5-6 CRC:crc16-modbus"
...
send_fmt = "Title:Modbus_TX  Slave:H1 Func:H2 Data:H3-6 CRC:crc16-modbus"
expect = "01 87 01 82 30"
expect_fmt = "Title:Modbus_Exception Slave:H1 ErrFunc:H2 Code:U3 CRC:crc16-modbus"
