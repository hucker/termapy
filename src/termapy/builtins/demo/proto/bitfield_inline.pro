...
send_fmt = "Title:Modbus_Write Slave:H1 Func:H2 Reg:U3-4 Value:H5-6 CRC:crc16-modbus"
expect = "01 06 00 00 0A 2B CF 75"
expect_fmt = "Title:Modbus_Echo Slave:H1 Func:H2 Reg:U3-4 Value:H5-6 CRC:crc16-modbus"

# Write sensor register (reg 1 = 0x04D2 = 1234)
[[test]]
name = "Setup — write sensor register"
send = "01 06 00 01 04 D2 5A 97"
send_fmt = "Title:Modbus_Write Slave:H1 Func:H2 Reg:U3-4 Value:U5-6 CRC:crc16-modbus"
expect = "01 06 00 01 04 D2 5A 97"
expect_fmt = "Title:Modbus_Echo Slave:H1 Func:H2 Reg:U3-4 Value:U5-6 CRC:crc16-modbus"
...
send_fmt = "Title:Modbus_Read Slave:H1 Func:H2 Addr:U3-4 Count:U5-6 CRC:crc16-modbus"
expect = "01 03 04 0A 2B 04 D2 0B 7E"
expect_fmt = "Title:Bitfield Slave:H1 Func:H2 Bytes:U3 Mode:B4-5.0-2 Chan:B4-5.3-5 Gain:B4-5.8-11 Sensor:U6-7 CRC:crc16-modbus"
...
send_fmt = "Title:Modbus_Read Slave:H1 Func:H2 Addr:U3-4 Count:U5-6 CRC:crc16-modbus"
expect = "01 03 04 0A 2B 04 D2 0B 7E"
expect_fmt = "Title:Binary Slave:H1 Func:H2 Bytes:U3 Ctrl:b4-5.0-15 Sensor:U6-7 CRC:crc16-modbus"
...
expect_fmt = "Title:Fail_Demo Slave:H1 Func:H2 Bytes:U3 Mode:B4-5.0-2 Chan:B4-5.3-5 Gain:B4-5.8-11 Sensor:U6-7 CRC:crc16-modbus"
