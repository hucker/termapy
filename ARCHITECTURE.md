...
```text
src/termapy/
├── app.py               # (3903 lines) Textual TUI — UI, modals, app hooks
├── cli.py               # (700 lines)  Plain-text CLI frontend — CLITerminal class
...
32 test files, 1505 tests, 67% overall coverage:
