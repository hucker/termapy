...
| **CRC tools**               | 100+ algorithms, `/proto.crc` list/help/calc with hex, text, or file input, check-string verification     | No built-in                             | No                         | No                           | CRC auto-calculation in sequences     | No                   |
